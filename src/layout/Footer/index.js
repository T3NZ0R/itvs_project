                ...
                <div className={styles.footerTopWrapper}>
                    <div className={styles.footerContacts}>
                        ...
                        <div className={styles.footerSocialWrapper}>
                            <Image className={styles.footerSocialItem} src={"icons/facebook.svg"} alt="facebook"/>
                            <Image className={styles.footerSocialItem} src={"icons/instagramCircle.svg"} alt="instagram"/>
                            <Image className={styles.footerSocialItem} src={"icons/google.svg"} alt="google"/>
                        </div>
                    </div>
                    <div className={styles.footerLocation}>
                        <Image className={styles.locationMap} src={"img/Map.png"} alt="Map"/>
                        <h3 className={styles.locationText}><Image className={styles.locationIcon} src={"icons/location.svg"} alt="location"
                ...
                <div className={styles.footerLinksWrapper}>
                    <a className={styles.footerLink} href="#">
                        <div className={styles.footerLinkTitle}>Дизайн сайту:
                            <div className={styles.footerLinkInfo}>
                                <Image src={"icons/instagram.svg"} alt="instagram"/> @yurii_oleskiv
                            </div></div>
                    </a>
                    <a className={styles.footerLink} target={"_blank"} href="https://linktr.ee/t3nz0r">
                        <div className={styles.footerLinkTitle}>Розробка сайту:
                            <div className={styles.footerLinkInfo}>
                                <Image src={"icons/instagram.svg"} alt="instagram"/> @t3nz0r
                            </div>
                        </div>
                    </a>
